...
//            // The file cannot be opened (permissions?)content response
...
//
//        // If a Range is provided, check its validitycontent response
//        if ($httpRange) {
...
//
//                $response->headers->set('Content-Range', sprintf('bytes %d-%d', 0, $fileSize));
